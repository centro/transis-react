...
exports.StateMixinLegacy = exports.PropsMixinLegacy = undefined;

var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; // Legacy support


var _helper = __webpack_require__(0);

// Legacy Prop Mixin
var PropsMixinLegacy = exports.PropsMixinLegacy = function PropsMixinLegacy(props) {
  return {
...
var TransisProvider = function TransisProvider(props) {
  ...
  var HigherOrderProvider = (0, _transisAware2.default)({
    global: global,
    state: mixState,
    props: mixProps
  }, function (coreProps) {
...
exports.default = TransisProvider;
...
// component will mount
var componentWillMountHelper = function componentWillMountHelper(_ref) {
  var _this = this;
...
var transisAwareStateInjection = function transisAwareStateInjection(_ref2, ComposedComponent) {
  ...
  var _ComposedComponent$pr = ComposedComponent.prototype,
      _ComposedComponent$pr2 = _ComposedComponent$pr.componentWillMount,
      componentWillMount = _ComposedComponent$pr2 === undefined ? function () {} : _ComposedComponent$pr2,
      _ComposedComponent$pr3 = _ComposedComponent$pr.componentDidMount,
      componentDidMount = _ComposedComponent$pr3 === undefined ? function () {} : _ComposedComponent$pr3,
      _ComposedComponent$pr4 = _ComposedComponent$pr.componentWillUnmount,
      componentWillUnmount = _ComposedComponent$pr4 === undefined ? function () {} : _ComposedComponent$pr4,
      _ComposedComponent$pr5 = _ComposedComponent$pr.componentDidUpdate,
...
exports.transisAwareStateInjection = exports.TransisProvider = exports.PropsMixin = exports.StateMixin = undefined;

var _transisAware = __webpack_require__(2);

var _transisAware2 = _interopRequireDefault(_transisAware);

var _transisAware3 = __webpack_require__(6);

var _transisAware4 = _interopRequireDefault(_transisAware3);

var _transisAware5 = __webpack_require__(7);

var _transisAware6 = _interopRequireDefault(_transisAware5);

var _transisAware7 = __webpack_require__(5);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _transisAware2.default;
exports.StateMixin = _transisAware7.StateMixinLegacy;
exports.PropsMixin = _transisAware7.PropsMixinLegacy;
exports.TransisProvider = _transisAware4.default;
exports.transisAwareStateInjection = _transisAware6.default;
