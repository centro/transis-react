...
/***/ function(module, exports, __webpack_require__) {
	...
	TransisObject.prototype.proxy = function (to, name) {
	  if (to instanceof TransisObject && typeof name === 'string') {
	...
	TransisObject.prototype.unproxy = function (to, name) {
	  if (this instanceof TransisObject && to instanceof TransisObject && typeof name === 'string') {
	...
	(function () {
	  ...
	  this.prototype._splice = function (i, n, added) {
	    ...
	    var _loop = function _loop(key) {
	      var proxy = _this2.__proxies__[key];
	    ...
	    for (var key in this.__proxies__) {
	      _loop(key);
	    }
	  ...
	  this.prototype.proxy = function (to, name) {
	    this.__proxies__ = this.__proxies__ || {};
	    this.__proxies__[to.objectId + "," + name] = { object: to, name: name };
	  ...
	  this.prototype.unproxy = function (to, name) {
	    var proxy = this.__proxies__[to.objectId + "," + name];
	    if (proxy) {
	      this.forEach(function (x) {
	        if (x instanceof _object2.default || x instanceof TransisArray) {
	          x._deregisterProxy(proxy.object, proxy.name);
